...
- [ ] Audit trail, compliance framework mapping (SOC2/PCI), SBOM/provenance ingestion — see `enterprise/DESIGN.md`'s remaining "Open questions"; audit trail is unblocked now that sessions carry real user identity
